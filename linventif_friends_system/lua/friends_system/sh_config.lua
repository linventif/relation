...
FriendsSys.Config.Admin = { // Admins
    ["superadmin"] = true,
    ["admin"] = true
}
FriendsSys.Config.Commands = { // Commands
    ["!friends"] = true,
    ["!friend"] = true,
    ["!amis"] = true,
    ["!ami"] = true
...
FriendsSys.Config.NPCModel = "models/Humans/Group02/Female_03.mdl" // Path of the model of the NPC